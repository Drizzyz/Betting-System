...
| $$__  $$            | $$    | $$    |__/                           /$$__  $$                      | $$                            
| $$  \ $$  /$$$$$$  /$$$$$$ /$$$$$$   /$$ /$$$$$$$   /$$$$$$       | $$  \__/ /$$   /$$  /$$$$$$$ /$$$$$$    /$$$$$$  /$$$$$$/$$$$ 
| $$$$$$$  /$$__  $$|_  $$_/|_  $$_/  | $$| $$__  $$ /$$__  $$      |  $$$$$$ | $$  | $$ /$$_____/|_  $$_/   /$$__  $$| $$_  $$_  $$
| $$__  $$| $$$$$$$$  | $$    | $$    | $$| $$  \ $$| $$  \ $$       \____  $$| $$  | $$|  $$$$$$   | $$    | $$$$$$$$| $$ \ $$ \ $$
| $$  \ $$| $$_____/  | $$ /$$| $$ /$$| $$| $$  | $$| $$  | $$       /$$  \ $$| $$  | $$ \____  $$  | $$ /$$| $$_____/| $$ | $$ | $$
| $$$$$$$/|  $$$$$$$  |  $$$$/|  $$$$/| $$| $$  | $$|  $$$$$$$      |  $$$$$$/|  $$$$$$$ /$$$$$$$/  |  $$$$/|  $$$$$$$| $$ | $$ | $$
|_______/  \_______/   \___/   \___/  |__/|__/  |__/ \____  $$       \______/  \____  $$|_______/    \___/   \_______/|__/ |__/ |__/
                                                     /$$  \ $$                 /$$  | $$                                            
                                                    |  $$$$$$/                |  $$$$$$/                                            
                                                     \______/                  \______/   


This is free and unencumbered code released into the public.

Anyone is free to use this source code but not to sell and redistribute, either
in source code form or as a compiled
binary, for any purpose, commercial or non-commercial, and by any
means.

In jurisdictions that recognize copyright laws, the author or authors
of this source code dedicate any and all copyright interest in the
source code to the public domain. We make this dedication for the benefit
...
ARISING FROM, OUT OF OR IN CONNECTION WITH THE SOURCE CODE OR THE USE OR
OTHER DEALINGS IN THE SOURCE CODE.
...
#define DIALOG_BETTING  1000
#define DIALOG_BETBLUE  1001
#define DIALOG_BETRED   1002
...
// Commands
CMD:setupbet(playerid, params[])
{
    new time, player1, player2;
    if(sscanf(params, "iii", time, player1, player2))
    {
        return SendMessage(playerid, -1, "Usage: /setupbet [bet time] [player 1] [player 2]");
    }
...
CMD:joinbetting(playerid, params[])
{
